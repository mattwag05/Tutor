...
class AddRecordRequest(BaseModel):
    ...
    # "co_writer" and "tutorbot" are retired surfaces; the values stay on this
    # write model so stale clients flushing queued records don't 400. Read-side
    # tolerance lives on services.notebook.service.RecordType.
