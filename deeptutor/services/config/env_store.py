...
# Deploy templates use __NAME__ sentinels (e.g. IMAGE_API_KEY=__OR_KEY__) that
# are meant to be substituted with a real value at provisioning time. If that
...
# clear "missing api_key" preflight error. Treat any unsubstituted token as unset.
_PLACEHOLDER_SECRET_RE = re.compile(r"^__[A-Z0-9_]+__$")


def _sanitize_secret(value: str | None) -> str:
    cleaned = (value or "").strip()
    return "" if _PLACEHOLDER_SECRET_RE.match(cleaned) else cleaned
    ...
    def as_summary(self) -> ConfigSummary:
        ...
        return ConfigSummary(
            ...
            llm={
                ...
                "api_key": _sanitize_secret(
                    values.get("LLM_API_KEY", os.getenv("LLM_API_KEY", ""))
                ),
            ...
            embedding={
                ...
                "api_key": _sanitize_secret(
                    values.get("EMBEDDING_API_KEY", os.getenv("EMBEDDING_API_KEY", ""))
                ),
            ...
            image={
                ...
                "api_key": _sanitize_secret(
                    values.get("IMAGE_API_KEY", os.getenv("IMAGE_API_KEY", ""))
                ),
            ...
            tts={
                ...
                "api_key": _sanitize_secret(
                    values.get("TTS_API_KEY", os.getenv("TTS_API_KEY", ""))
                ),
            ...
            asr={
                ...
                "api_key": _sanitize_secret(
                    values.get("ASR_API_KEY", os.getenv("ASR_API_KEY", ""))
                ),
            ...
            video={
                ...
                "api_key": _sanitize_secret(
                    values.get("VIDEO_API_KEY", os.getenv("VIDEO_API_KEY", ""))
                ),
            ...
            search={
                ...
                "api_key": _sanitize_secret(
                    values.get("SEARCH_API_KEY", os.getenv("SEARCH_API_KEY", ""))
                ),
