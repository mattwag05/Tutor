...
# "classroom" was retired with the Classroom surface; leftover review_state
# rows with that source are simply never queried by the picker.
ReviewSource = Literal["book", "course"]
