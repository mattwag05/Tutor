...
Sources dispatched:
    ...
    classroom  -> ``GET /api/spaced-review/block`` via ``web_lookup.fetch_block_content``
...
resolvable (book deleted, classroom rewritten, course block removed,
web/ unreachable) are silently dropped — the user shouldn't see ghost
