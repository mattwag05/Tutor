"""HTTP bridge to web/'s course storage for the spaced-review
picker.

The Python backend can't read ``data/courses/<id>.json`` natively (they're owned by Next.js / web/),
so the picker delegates course content lookups to
