      ...
      {mode === 'submitted' && (
        <div className="mt-6 text-center text-sm text-neutral-400">
          {pct >= 70
            ...
            : 'Review the explanations below to reinforce the material.'}
        </div>
      )}
    </div>
  );
    ...
    >
      ...
      <p className="text-base leading-relaxed text-neutral-800 dark:text-neutral-100">
        {parts.map((part, i) => (
          <span key={i}>
            {part}
            {i < parts.length - 1 && (
              <span className="mx-1 inline-block min-w-16 border-b-2 border-neutral-400 align-baseline">
                &nbsp;
              </span>
            )}
          </span>
      ...
      {mode === 'submitted' && (
        <div className="mt-4 border-t border-neutral-200 pt-3 dark:border-neutral-700">
          ...
          >
            {answer === null ? 'Not answered' : correct ? 'Correct' : 'Incorrect'}
          </span>
