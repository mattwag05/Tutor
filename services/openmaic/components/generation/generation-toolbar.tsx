...
import { BookOpen, Bot, Check, ChevronLeft, Globe, Loader2, Paperclip, FileText, X, Globe2 } from 'lucide-react';
...
export interface GenerationToolbarProps {
  ...
  onKnowledgeBaseChange: (kb: string | null) => void;
}
        ...
        <Popover>
          <PopoverTrigger asChild>
            <button className={knowledgeBase ? pillActive : pillMuted}>
              ...
              {knowledgeBase && (
                <span className="max-w-[100px] truncate">{knowledgeBase}</span>
              )}
            </button>
          </PopoverTrigger>
