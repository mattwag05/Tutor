 ...
 *
 * GET /api/spaced-review/block?source=course&source_id=...
 *
 ...
 * duplicating course storage on the backend. `book` is resolved
 * in-process via BookEngine and is NOT supported here. The picker never
 * requests `classroom` (excluded from ReviewSource); a direct request
 * 400s here as unsupported.
 *
 * source_id format:
