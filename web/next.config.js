...
const nextConfig = {
  ...
  // Classroom was retired (Course is the single learning surface). Send
  // bookmarked / PWA-cached classroom links somewhere useful.
  async redirects() {
    return [
      {
        // :path* also matches bare /classroom (zero segments)
